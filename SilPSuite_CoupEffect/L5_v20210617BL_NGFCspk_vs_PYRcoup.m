...
bs.name=['B']; bs.num=['178']; bs.exp=['g'];bs.ngfc=['gls01'];
an.units=[14]; %give the PYR units included in the current session 
%
an.ngfc=[20]; %give the number (sorrend szam!) for the NGFC

...
un_shnk =[];                       %shanks from which unit was isolated
...
th_pname=strcat(bs.name,'THP.txt');  %theta periods
...
writename=strcat(bs.name, bs.cell, '_unitcharGLASS_forintTHTonly.mat');
save(writename, 'datum', 'char_GLunits','t_rec','glassp_all','glassp_tht','-v7.3');

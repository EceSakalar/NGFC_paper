...
bs.name=['B']; bs.num=['206']; bs.exp=['a'];bs.ngfc=['s3u36_limited'];
an.units=[5,7,9,17,18,19,20]; %give the PYR units included in the current session 
%
an.ngfc=[10]; %give the number (sorrend szam!) for the NGFC
